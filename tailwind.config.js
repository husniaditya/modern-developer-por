...
const defaultTheme = {
  ...
  extend: {
    ...
    animation: {
      ...
      'star-glow-top': 'star-glow-top linear infinite',
      'star-glow-right': 'star-glow-right linear infinite',
      'star-glow-bottom': 'star-glow-bottom linear infinite',
      'star-glow-left': 'star-glow-left linear infinite',
