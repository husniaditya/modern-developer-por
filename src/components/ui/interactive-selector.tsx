...
const InteractiveSelector = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-[#222] font-sans text-white"> 
      ...
      <div className="options hidden md:flex w-full max-w-[900px] min-w-[600px] h-[400px] mx-0 items-stretch overflow-hidden relative">
        {options.map((option, index) => (
          <div
            key={index}
            className={`
              option relative flex flex-col justify-end overflow-hidden
      ...
      {/* Options Container - Mobile (Vertical Stack) */}
      <div className="flex md:hidden flex-col w-full max-w-[350px] mx-auto px-4 gap-0 overflow-hidden relative">
        {options.map((option, index) => (
          <div
            key={index}
            ...
            style={{
              ...
              transitionTimingFunction: 'ease-in-out',
              height: activeIndex === index ? '200px' : '60px',
              minHeight: '60px',
              margin: 0,
              borderRadius: '8px',
          ...
          >
            ...
            <div className="absolute left-0 right-0 bottom-3 flex items-center justify-start h-10 z-[2] pointer-events-none px-3 gap-2 w-full">
              <div className="min-w-[36px] max-w-[36px] h-[36px] flex items-center justify-center rounded-full bg-[rgba(32,32,32,0.85)] backdrop-blur-[10px] shadow-[0_1px_4px_rgba(0,0,0,0.18)] border-2 border-[#444] flex-shrink-0 flex-grow-0 [&>svg]:w-[18px] [&>svg]:h-[18px]">
                {option.icon}
              </div>
              <div className="text-white whitespace-nowrap relative overflow-hidden">
                <div 
                  className="font-bold text-sm transition-all duration-500 ease-in-out"
                  style={{
                    opacity: 1,
                ...
                <div 
                  className="text-xs text-gray-300 transition-all duration-500 ease-in-out"
                  style={{
                    opacity: activeIndex === index ? 1 : 0,
